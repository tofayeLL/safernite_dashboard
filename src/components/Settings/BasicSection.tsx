...
const BasicSection = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      // Only send userName to backend as per your requirement
      const updateData = {
  ...
  return (
    <div className="">
          ...
          <div className="flex items-center gap-10">
            <div>
              ...
              <div className="relative w-24 h-24">
                ...
                >
                  <MdEdit className="h-4 w-4 cursor-pointer" />
                </button>
              </div>
            </div>
      ...
      <Button
        onClick={handleSave}
        disabled={isLoading || !profile.userName.trim()}
        className="bg-[#08E9DB] hover:bg-[#12b6ab] text-black px-8 mt-6 py-3 cursor-pointer"
      >
